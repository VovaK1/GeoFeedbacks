    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          (0,_js_ymaps__WEBPACK_IMPORTED_MODULE_2__.updateMap)(placemarks, map);
          coords = [];
          map.events.add('click', function (e) {
            coords = [];

            if (!map.balloon.isOpen()) {
              coords = (0,_js_ymaps__WEBPACK_IMPORTED_MODULE_2__.openBalloon)(map, e);
            } else {
              map.balloon.close();
            }
          });
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime-0df34d"], () => (__webpack_require__("./src/index.js")))
